...
class Boxplot(RectChart):
    ...
    def add_yaxis(
        self,
        series_name: str,
        y_axis: echarts_types.Optional[
            echarts_types.Sequence[echarts_types.Union[opts.BoxplotItem, dict]]
        ] = None,
        *,
        ...
        dataset_index: echarts_types.Optional[echarts_types.Numeric] = None,
        box_width: echarts_types.Optional[echarts_types.Sequence] = None,
        selected_mode: echarts_types.Union[bool, str] = False,
        label_opts: echarts_types.Label = opts.LabelOpts(),
        markpoint_opts: echarts_types.MarkPoint = opts.MarkPointOpts(),
        markline_opts: echarts_types.MarkLine = opts.MarkLineOpts(),
