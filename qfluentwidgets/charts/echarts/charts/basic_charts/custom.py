...
class Custom(Chart):
    ...
    def add(
        self,
        series_name: str,
        render_item: echarts_types.JSFunc,
        *,
        color_by: str = "series",
        is_legend_hover_link: bool = True,
        coordinate_system: echarts_types.JSFunc = "cartesian2d",
        x_axis_index: echarts_types.Numeric = 0,
        y_axis_index: echarts_types.Numeric = 0,
        polar_index: echarts_types.Numeric = 0,
        geo_index: echarts_types.Numeric = 0,
        calendar_index: echarts_types.Numeric = 0,
        ...
        encode: echarts_types.Union[echarts_types.Sequence, dict, None] = None,
        data: echarts_types.Optional[echarts_types.Sequence] = None,
        is_clip: bool = True,
