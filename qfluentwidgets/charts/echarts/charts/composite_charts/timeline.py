...
class Timeline(Base):
    ...
    def __init__(
        ...
        self.add_schema()
        self._time_points: echarts_types.Sequence = []

    def add_schema(
        self,
        axis_type: str = "category",
        current_index: echarts_types.Numeric = 0,
        orient: str = "horizontal",
        symbol: echarts_types.Optional[str] = None,
        symbol_size: echarts_types.Optional[echarts_types.Numeric] = None,
        play_interval: echarts_types.Optional[echarts_types.Numeric] = None,
        ...
        pos_bottom: echarts_types.Optional[str] = "-5px",
        ...
        checkpointstyle_opts: echarts_types.TimeLinkCheckPoint = None,
        controlstyle_opts: echarts_types.TimeLineControl = None,
        progress_linestyle_opts: echarts_types.LineStyle = None,
        progress_itemstyle_opts: echarts_types.ItemStyle = None,
        progress_label_opts: echarts_types.Label = None,
    ):
