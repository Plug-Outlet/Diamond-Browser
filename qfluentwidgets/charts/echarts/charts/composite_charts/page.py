...
class Page(CompositeMixin):
    ...
    def __init__(
        ...
        layout: echarts_types.Union[PageLayoutOpts, dict] = PageLayoutOpts(),
    ):
    ...
    def _assembly_layout(self, layout: echarts_types.Union[PageLayoutOpts, dict]) -> str:
    ...
    def save_resize_html(
        ...
        *,
        cfg_file: echarts_types.Optional[str] = None,
        cfg_dict: echarts_types.Optional[list] = None,
